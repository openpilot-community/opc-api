...
JsonapiSpecHelpers::Payload.register(:vehicle_model_option) do
  key(:vehicle_year, Integer)
  key(:vehicle_make_id, Integer)
  key(:vehicle_model_id, Integer)
  key(:vehicle_option_id, Integer)
  key(:vehicle_option_availability_id, Integer)
