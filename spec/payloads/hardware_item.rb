...
JsonapiSpecHelpers::Payload.register(:hardware_item) do
  key(:name, String)
  key(:alternate_name, String)
  key(:description, String)
  key(:compatible_with_all_vehicles, [TrueClass, FalseClass])
  key(:available_for_purchase, [TrueClass, FalseClass])
  key(:purchase_url, String)
  key(:requires_assembly, [TrueClass, FalseClass])
  key(:can_be_built, [TrueClass, FalseClass])
  key(:build_plans_url, String)
  key(:notes, String)
  key(:image_url, String)
  key(:install_guide_url, String)
